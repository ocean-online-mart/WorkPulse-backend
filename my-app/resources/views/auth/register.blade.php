            ...
            <div class="col-lg-7 col-md-12 col-sm-12">
                <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap">
                    <div class="col-md-7 mx-auto vh-100">
                        <form method="POST" action="{{ route('register') }}" class="vh-100">
                            @csrf
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="name" id="name" class="form-control border-end-0" value="{{ old('name') }}" required autofocus>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="email" name="email" id="email" class="form-control border-end-0" value="{{ old('email') }}" required>
                                            <span class="input-group-text border-start-0">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="pass-group">
                                            <input type="password" name="password_confirmation" id="password_confirmation" class="pass-inputs form-control" required>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="form-check form-check-md mb-0">
                                                <input class="form-check-input" id="terms" type="checkbox" name="terms" required>
                                                <label for="terms" class="form-check-label text-dark mt-0">Agree to <span class="text-primary">Terms & Privacy</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center flex-wrap">
                                            ...
                                            <div class="text-center flex-fill">
                                                <a href="javascript:void(0);" class="bg-dark br-10 p-2 btn btn-dark d-flex align-items-center justify-content-center">
                                                    <img class="img-fluid m-1" src="{{ asset('theme/img/icons/apple-logo.svg') }}" alt="Apple">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
